...
//  huaxiafinance_user
//
//  Created by huaxiafinance on 16/3/9.
...
- (UIView *)creatSelectButton{
    ...
    for (int i = 0; i < self.selectArray.count; i++) {
        ...
        button.frame = CGRectMake(5, i * (cellHeight+1), CC_SCREEN_WIDTH-10, cellHeight);
    ...
    cancelButton.frame = CGRectMake(5, viewHeight - cellHeight-5, CC_SCREEN_WIDTH-10, cellHeight);
