////
////  HXIdCardVerificationViewController.m
////  ConsumerFinance
////
...
//@interface HXIdCardVerificationViewController ()<UITableViewDelegate,UITableViewDataSource,UITextFieldDelegate>
//{
...
//@end
//
//@implementation HXIdCardVerificationViewController
//-(id)init {
//    self = [super init];
//    if (self) {
//        self.viewModel = [[HXIdCardVerificationViewModel alloc] initWithController:self];
//    }
//    return self;
//}
//- (void)viewDidLoad {
...
//    if (_idCardCell.writeTextfield.text.length >=15 ) {
...
//        return;
//    }
//    [self.viewModel submitIdCard:_idCardCell.writeTextfield.text returunBlock:^{
//        
//        SetTradePWDViewController * trade = [[SetTradePWDViewController alloc] init];
