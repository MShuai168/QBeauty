...
//    [self.cancelBtn setTitleColor:RGBA(0, 122, 255, 1) forState:UIControlStateNormal];
    [self.cancelBtn setTitleColor:[UIColor colorWithHex:0xdf4f0e] forState:UIControlStateNormal];
...
//    [self.conpleteBtn setTitleColor:RGBA(0, 122, 255, 1) forState:UIControlStateNormal];
    [self.conpleteBtn setTitleColor:[UIColor colorWithHex:0xdf4f0e] forState:UIControlStateNormal];
    ...
    self.selectLb.textColor = [UIColor colorWithHex:0x9a9a9a];
...
- (void)creatDate:(UIDatePickerMode)DatePickerMode{
    ...
    [comps setDay:0];//设置最小时间为：当前时间 + 30分钟
    [comps setMinute:30];
    NSDate *minDate = [calendar dateByAddingComponents:comps toDate:currentDate options:0];
    [self.datePickeV setMaximumDate:maxDate];
    [self.datePickeV setMinimumDate:minDate];
}
