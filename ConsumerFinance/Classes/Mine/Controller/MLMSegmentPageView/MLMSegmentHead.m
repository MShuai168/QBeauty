...
- (CGFloat)titleWidth:(NSString *)title {
    CGFloat sys_font = _fontScaleX>1?_fontSize*_fontScaleX:_fontSize;
...
- (void)createView {
    ...
    _fontScaleX = _headStyle==SegmentHeadStyleSlide?1:_fontScaleX;
...
- (void)scrollViewSubviews:(UIScrollView*)scroll {
    ...
    if (titles && _headStyle != SegmentHeadStyleSlide) {
        ...
        if (_fontScaleX != 1) {
            curBtn.titleLabel.font = [UIFont systemFontOfSize:_fontSize*_fontScaleX];
        }
...
- (void)changeSelectIndexPage:(NSInteger)index {
    {
        ...
        [UIView animateWithDuration:animation_time animations:^{
            ...
            if (_fontScaleX) {
                ...
                select_btn.titleLabel.font = [UIFont systemFontOfSize:_fontSize*_fontScaleX];
            }
...
- (void)fontChangeCurBtn:(UIButton *)curBtn nextBtn:(UIButton *)nextBtn changeScale:(CGFloat)changeScale{
    //button字体改变的大小
    CGFloat btn_font_change = _fontSize*(_fontScaleX - 1);
    //大小变化
    CGFloat next_font = _fontSize + changeScale*btn_font_change;
    CGFloat cur_font = _fontSize*_fontScaleX - changeScale*btn_font_change;
