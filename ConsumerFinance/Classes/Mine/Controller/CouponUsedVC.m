...
#import "CouponUsedVC.h"
#import "CouponUnusedCell.h"
#import "CouponDetailViewController.h"

@interface CouponUsedVC () <UITableViewDelegate, UITableViewDataSource>
...
- (void)loadUsedCoouponData {
    [MBProgressHUD showMessage:nil toView:self.view];  //优惠券：S_HYYHQZT_WSY-未使用、S_HYYHQZT_YSY-已使用、S_HYYHQZT_YGQ-已过期
    NSDictionary *parameters = @{@"type":@"S_HYYHQZT_YSY", @"page":[NSString stringWithFormat:@"%d",self.page], @"pageSize":@10};
