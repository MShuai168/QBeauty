...
#import "CouponOverdueVC.h"
#import "CouponUnusedCell.h"
#import "CouponDetailViewController.h"

@interface CouponOverdueVC () <UITableViewDelegate, UITableViewDataSource>
...
@implementation CouponOverdueVC
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell configCellWithModel:model withType:3];
    return cell;
}
...
- (void)loadOverdueCoouponData {
    [MBProgressHUD showMessage:nil toView:self.view];  //优惠券：S_HYYHQZT_WSY-未使用、S_HYYHQZT_YSY-已使用、S_HYYHQZT_YGQ-已过期
    NSDictionary *parameters = @{@"type":@"S_HYYHQZT_YGQ", @"page":[NSString stringWithFormat:@"%d",self.page], @"pageSize":@10};
