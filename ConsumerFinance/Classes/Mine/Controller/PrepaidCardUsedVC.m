...
#import "PrepaidCardUsedVC.h"
#import "PrepaidCardUsedCell.h"
#import "PrepaidCardUsedDetailVC.h"

@interface PrepaidCardUsedVC ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation PrepaidCardUsedVC
...
- (void)loadDataOfPrepaidCard {
    [MBProgressHUD showMessage:nil toView:self.view];  //S_CKZT_SYZ  S_CKZT_YSX
    NSDictionary *parameters = @{@"type":@"S_CKZT_SYZ", @"page":[NSString stringWithFormat:@"%d",self.page], @"rows":@10};
